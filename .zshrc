...
plugins=(zsh-completions fabric oc git rsync tmux vi-mode history history-substring-search copyfile web-search systemd dnf jsontools go golang docker zsh-autosuggestions z zsh_reload zsh-syntax-highlighting node)
